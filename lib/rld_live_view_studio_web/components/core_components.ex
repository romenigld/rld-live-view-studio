defmodule RldLiveViewStudioWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RldLiveViewStudioWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RldLiveViewStudioWeb.Gettext, "errors", msg, opts)
    end
  end
